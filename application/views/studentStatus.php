...
<div id="middle_content_inner"><!--Middle Content Start -->		
				...
				<form action="<?php echo base_url();?>index.php/welcome/studentvarified" method="post">
					<table class="con_tab">
						
									<tr>
										<td><span class="red">*</span>Enrollment No</td>
										<td class="colon">:</td>
										<td><input type="text" class="tbox" name="select_name" id="select_name"></td>
										<td><input class="button" type="submit" value="Submit" onclick="return ValidateForm();" name="sbmt"></td>										
									</tr>
